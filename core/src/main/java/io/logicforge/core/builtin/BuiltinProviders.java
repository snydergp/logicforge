...
public final class BuiltinProviders {
  ...
  private static final List<Class<?>> BUILTIN_PROVIDERS = List.of(ConditionalActions.class,
      BooleanConverters.class, DecimalConverters.class, IntegerConverters.class,
