...
public final class BuiltinProviders {
  ...
  private static final List<Class<?>> BUILTIN_PROVIDERS =
      List.of(ConditionalActions.class, VariableActions.class, BooleanConverters.class,
          DecimalConverters.class, IntegerConverters.class, StringConverters.class,
          LogicFunctions.class, MathFunctions.class, TextFunctions.class, VariableFunctions.class);
