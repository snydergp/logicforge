...
import processConfig from '../../data/process-config.json';
import { EngineSpec, ProcessConfig } from '../../../types';
import engineSpec from '../../data/engine-spec.json';
import React, { useCallback } from 'react';
import { mergeDeep } from '../../../util';
import { MessageTree } from '../../../components/I18n/I18n';
import translations from '../../../i18n/en.json';
import customTranslations from '../../data/custom-translations.json';
